...
<div class="form-group">
    ...
    <?=Form::hidden('articleCover',isset($article)?$article->article_cover->file_url:null,['id'=>'articleCover'])?>
    <img src="{{isset($article)?$article->article_cover->file_url:null}}" id="coverPreview"
...
<div class="row">
    ...
    <div class="col-xs-6">
        <div class="form-group">
            ...
            <?=Form::text('articleOriginUrl',isset($article)?$article->article_origin_url:null,['id'=>'articleOriginUrl','class'=>'form-control'])?>
        </div>
    </div>
</div>
