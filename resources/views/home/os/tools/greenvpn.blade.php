...
@section('main')
    <div class="col-xs-8">
        ...
        <p>
            网上有很多网站都可以找到免费的VPN账号，如果不是工作需要经常用，仅是抱着“世界那么大，我想去看看”的想法， 大可不必开通VIP套餐，多上几个网站找找，不断打游击战即可；
        </p>
        <p>
            如果是编程、外贸等对外国网站有强烈依赖的用户，建议开通VIP套餐，毕竟免费的账号不同程度上都存在不稳 定、限流量、打开慢等各种坑爹的情况，与其省这么一点小钱，不如提高工作效率，提升自己的职场竞争力
        </p>
        <p>个人认为开通包年的套餐是最划算的，平均13元/月，又能支持电脑与手机两台设备，何乐而不为呢？</p>
        <p>
        ...
        <p>由于VPN服务器大多搭建在国外，所以你使用VPN服务之后就相当于你是在国外访问国内的网站了 至于解决方法嘛，没有什么问题是可以难倒无所不能的中国人的（此处只讲Mac系统的操作方法）
        </p>
        <p>首先从谷歌代码库中下载代码包：
